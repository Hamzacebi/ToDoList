...
namespace DataAccess.DataAccessOfToDoList.Concretes.RepositoriesOfEntities
{
    ...
    public class RepositoryOfCategory : BaseForEntitiesOfToDoList<Categories>, IRepositoryOfCategory
    {
        private bool disposedValue;

        public RepositoryOfCategory(DbContext dbContext, Type inWhichDbContext) : base(dbContext, inWhichDbContext)
        {
